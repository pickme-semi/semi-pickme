    ...
    <div class="numbertext" >1 / 6</div>
      ...
      <div class="row" align="center">
		<div class="col-md-6" align="center" > <!--픽 이미지 1  -->
			<img id="pick1" src="/pickme/resources/images/img_sample1.jpg" onclick="selectLeft()"  />
		</div>	
		<div class="col-md-6" align="center"> <!--픽 이미지 2 -->
			<img id="pick2" src="/pickme/resources/images/img_sample2.jpg" onclick="selectRight()" />
		</div>
		</div> 
