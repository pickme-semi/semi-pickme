...
<div class="row">
   <div class="col pm-input-form col-xs-12 col-sm-6 col-md-6 col-lg-7" style=" margin-top :100px;">
         <div id="infomain" style="margin-top:auto;margin-bottom:auto" align="center">
            ...
            <div id="live-swell-result-a" class="aa live-swell__results__result live-swell__results__result--a option option-a">
             sdfsfsdfsdfsdfsdf
             <p class ="alphaLeftColor" id="leftP">sdfsdfsdfsf</p>
            </div>
            <div id="live-swell-result-b" class="bb live-swell__results__result live-swell__results__result--b option option-b">
            <p class ="alphaRightColor" id="rightP"></p>
            </div>
            </div>
