...
<body>
        ...
        <th scope="row">
            <label for="customerEmail" class="thin_ic">
        ...
        <td>
            ...
            <div class="email complete" style="display: block;">
                ...
                <span class="sel ml" style="width:100px">
                    ...
                    <option>naver.com</option><option>daum.net</option><option>nate.com</option><option>gmail.com</option><option>hotmail.com</option><option>outlook.com</option><option>yahoo.co.kr</option><option>korea.com</option><option>dreamwiz.com</option><option>chol.com</option></select>
                    <br><br></span> 
            ...
            <input type="hidden" id="customerEmail" class="contents" value="@">
            <input type="hidden" class="itemNo" value="4"> 
        </td> 
    </tr>
    ...
    <tr class="itemArea TEXT" sort="2" itemno="5" requiredyn="Y" inputlength="100" datatype="CHAR"> 
        <th scope="row">
            <label for="inquiryTitle" class="thin_ic">
                <span class="bl_ess">필수</span>
                <span class="itemExpression">신고제목</span><br><br>
            </label>
        </th>
        <td>
            <div class="pr">
    ...
    <tr class="itemArea TEXT" sort="2" itemno="5" requiredyn="Y" inputlength="100" datatype="CHAR"> 
        <th scope="row">
            <label for="inquiryTitle" class="thin_ic">
                <span class="bl_ess">필수</span>
                <span class="itemExpression">신고 주소</span><br><br>
            </label>
        </th>
        <td>
            <div class="pr">
    ...
    <tr class="itemArea HTML" sort="3" itemno="13" requiredyn="Y">
        <th scope="row">
            <label for="inquiryContent" class="thin_ic">
                <span class="bl_ess">필수</span>
                <span class="itemExpression">신고내용</span><br><br>
            </label>
        </th>
        <td>
            <div class="pr">
                <textarea id="inquiryContent" class="contents inp" cols="30" rows="4" maxlength="5000" style="width:482px; height: 300px"></textarea>
    ...
    <tr class="itemArea HIDDEN" sort="4" itemno="2" requiredyn="N" style="display: none;">
        <td colspan="2">
    ...
    <tr class="itemArea PHONE" sort="5" itemno="8" requiredyn="N" inputlength="30">
        <th scope="row">
            <label for="cellphoneNumber" class="thin_ic">
                
                <span class="itemExpression"><br><br>답변알림<br><br></span>
            </label>
        </th>
        <td>
            ...
            <p class="caution_tb" style="font-size:12px; color: gray" >
                
                <span class="mk_ex" ></span>
                	문의하신 신고 내용의 답변 완료 시 선택하신 방법으로 알려드립니다.  <br>  
                	SMS 발송 : 09시~21시까지 발송하며, 심야 처리건은 다음날 09시에 자동 발송됩니다.
            </p>
            
            <input type="hidden" id="cellphoneNumber" class="contents phone" value="">
            <input type="hidden" class="itemNo" value="8">
        </td>
    </tr><tr class="itemArea FILE" sort="6" itemno="37" requiredyn="N">
        <th scope="row">
            <label for="attachFile" class="thin_ic">
                
                <span class="itemExpression">파일첨부</span>
            </label>
        </th>
        <td>
            <div class="pr">
                ...
                <p class="caution_tb" style="font-size:12px; color: gray"><span class="mk_ex"></span>10M 이내 파일만 3개까지 첨부 가능합니다.<br>실행파일(exe), 링크(link), 아이콘(ico)은 첨부되지 않습니다.</p>
            </div>
        </td>
    </tr><tr class="itemArea ACPINFO last" sort="7" itemno="112" requiredyn="Y">
        <td colspan="2">
            <div>
            
                <p class="caution_tb" style="font-size:12px; color: gray"><span class="mk_ex" style="font-size:9px"></span><br><br><br>수집된 개인정보는 (아이디, 이메일, 휴대폰번호) 문의내용 처리 및 고객불만의 해결을 위해 사용되며,<br>전자상거래법에 따라 3년간 보관 후 삭제됩니다.</p>
            
                <p class="caution_tb" style="font-size:12px; color: gray"><span class="chk"><input type="checkbox" id="acpinfo" class="contents" value="N"></span><label for="acpinfo">위, 개인정보 수집 및 이용에 동의합니다.</label></p>
