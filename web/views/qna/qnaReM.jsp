...
<!-- 관리자 전용 답변 테이블 전송 누를 시 메일로 답변 받을 수 있도록!
	qnaListM 에서 답변으로 이어지는 페이지  -->
            ...
            <form id="inquiryForm" name="inquiryForm" method="post" action="" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="tbl inplist">
                        <table>
                            <caption><span>문의 내용 및 기타 정보 입력</span></caption>
    ...
    </tr><tr class="itemArea TEXT" sort="2" itemno="5" requiredyn="Y" inputlength="100" datatype="CHAR"> 
        <th scope="row">
            <label for="inquiryTitle" class="thin_ic">
                <span class="bl_ess">필수</span>
                <span class="itemExpression">문의제목</span><br><br>
            </label>
        </th>
        <td>
            <div class="pr">
        ...
        <th scope="row">
            <label for="inquiryContent" class="thin_ic">
                <span class="bl_ess">필수</span>
                <span class="itemExpression">문의내용</span><br><br>
            </label>
        </th>
        <td>
            <div class="pr">
        ...
        <td>
            ...
            <p class="caution_tb" style="font-size:12px; color: gray" >
                ...
                <span class="mk_ex" ></span>
                	문의하신 내용의 답변 완료 시 선택하신 방법으로 알려드립니다.  <br>  
